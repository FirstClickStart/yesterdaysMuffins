...
public class SensorsApi_ClientConnectionCallback
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("ActiveDisco.SensorsApi+ClientConnectionCallback, ActiveDisco, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", SensorsApi_ClientConnectionCallback.class, __md_methods);
	}


	public SensorsApi_ClientConnectionCallback () throws java.lang.Throwable
	{
		super ();
		if (getClass () == SensorsApi_ClientConnectionCallback.class)
			mono.android.TypeManager.Activate ("ActiveDisco.SensorsApi+ClientConnectionCallback, ActiveDisco, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
