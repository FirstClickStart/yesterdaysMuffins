...
{
    [Activity(MainLauncher = false,Label = "@string/app_name",
               Theme = "@style/AppTheme")]
    public class SensorsApi : Activity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.sensors_view);
            InitializeLogging();
        ...
        void InitializeLogging()
        {
            ...
            var msgFilter = new CommonSampleLibrary.MessageOnlyLogFilter();
